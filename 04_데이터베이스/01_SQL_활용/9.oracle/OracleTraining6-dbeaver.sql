...
SELECT 
	...
	ROUND(1234.5678, 1) AS ROUND_1,	-- 소수점 1자리까지 표시
	ROUND(1234.5678, 2) AS ROUND_2,	-- 소수점 2자리까지 표시
	ROUND(1234.5678, -1) AS ROUND_MINUS1,  -- 1자리에서 반올림
	ROUND(1234.5678, -2) AS ROUND_MINUS2  -- 2자리에서 반올림
FROM DUAL;
...
SELECT 
	...
	TRUNC(1234.5678, 1) AS TRUNC_1,	-- 소수점 1자리까지만
	TRUNC(1234.5678, 2) AS TRUNC_2,	-- 소수점 2자리까지만
	TRUNC(1234.5678, -1) AS TRUNC_MINUS1,  -- 1자리 버림
	TRUNC(1234.5678, -2) AS TRUNC_MINUS2  -- 2자리 버림
FROM DUAL;
