...
CREATE TABLE TABLE_NOTNULL2(
  LOGIN_ID VARCHAR2(20) CONSTRAINT TBLNN2_LGNID_NN NOT NULL, -- 명명규칙: 테이블명_컬럼명_타입
...
INSERT INTO TABLE_UNIQUE(login_id, login_pwd, tel)
VALUES('TEST_ID_01', 'PWD01', '010-1234-5678'); -- ORA-00001: 무결성 제약 조건 위배
...
-- 14-19 : UNIQUE 제약조건 컬럼에 NULL을 입력 할수 있음 -- UNIQUE는 NULL 허용 
INSERT INTO TABLE_UNIQUE(login_id, login_pwd, tel)
...
INSERT INTO TABLE_PK2(login_id, login_pwd, tel)
VALUES('TEST_ID_01', 'PWD01', '010-1234-5678');   -- ORA-00001: 무결성 제약 조건

-- 14-35 : PRIMARY KEY에 NULL을 입력
INSERT INTO TABLE_PK2(login_id, login_pwd, tel)   -- SQL 오류: ORA-01400
VALUES(NULL, 'PWD01', '010-1234-5678'); 

-- 14-36 : PRIMARY KEY 컬럼 생략 시도 
INSERT INTO TABLE_PK(login_pwd, tel)    -- 오류 보고 -ORA-01400
...
VALUES(9999, '홍길동', 'CLERK', '7788', TO_DATE('2017/04/03', 'YYYY/MM/DD'), 1200, NULL, 50);
