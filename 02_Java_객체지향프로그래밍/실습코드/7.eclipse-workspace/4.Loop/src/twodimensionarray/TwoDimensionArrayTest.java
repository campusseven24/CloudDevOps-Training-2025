...
public class TwoDimensionArrayTest {
	...
	public static void main(String[] args) {
		...
		int[][] scores = {
			{85,    90,    78},	// 행 인덱스 0: 1번 학생의 수학(0), 영어(1), 과학(2) 점수
			{92,    88,    95}, // 행 인덱스 1: 2번 학생의 수학(0), 영어(1), 과학(2) 점수
			{78,    85,    82}, // 행 인덱스 2: 3번 학생의 수학(0), 영어(1), 과학(2) 점수
			{95,    92,    88}, // 행 인덱스 3: 4번 학생의 수학(0), 영어(1), 과학(2) 점수
			{88,    79,    91}  // 행 인덱스 4: 5번 학생의 수학(0), 영어(1), 과학(2) 점수
		};
		...
		System.out.println("scores[0][0] = " + scores[0][0]); // 1번 학생 수학점수
		System.out.println("scores[0][1] = " + scores[0][1]); // 1번 학생 영어점수
		System.out.println("scores[0][2] = " + scores[0][2]); // 1번 학생 과학점수
